...
class SVMAlgorithm:
    ...
    def predict(self, x_test, y_test=[], accuracy=True):
        ...
        self.predict_test = svm.predict(x_test);
    ...
    def validateAlgorithm(self, forecasters_base, target_base):
        ...
        self.predict_training = svm.predict(self.x_training);
        ...
        self.average_cross_validation = cross_val_score(svm, forecasters_base, target_base, cv = kfold).mean() * 100.0;
