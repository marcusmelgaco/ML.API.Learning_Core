...
class KNNAlgorithm:
    ...
    def predict(self, x_test, y_test=[], accuracy=True):
        ...
        self.predict_test = knn.predict(x_test);
    ...
    def validateAlgorithm(self, forecasters_base, target_base):
        ...
        self.predict_training = knn.predict(self.x_training);
        ...
        self.average_cross_validation = cross_val_score(knn, forecasters_base, target_base, cv = kfold).mean() * 100.0;
