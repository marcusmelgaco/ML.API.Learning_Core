...
class LinearRegressionAlgorithm:
    ...
    def learning(self, x_training, y_training):
        ...
        self.determination_coefficient_training = linear.score(self.x_training, self.y_training);
    ...
    def validateAlgorithm(self, forecasters_base, target_base):
        ...
        self.predict_training = linear.predict(self.x_training);
        ...
        self.average_cross_validation = cross_val_score(linear, forecasters_base, target_base, cv = kfold).mean() * 100.0;
