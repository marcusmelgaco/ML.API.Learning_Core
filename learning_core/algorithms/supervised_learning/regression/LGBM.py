...
lgb = lgb.LGBMRegressor(num_leaves=50, max_depth=3, learning_rate=0.1, n_estimators=50, random_state=10)
...
class LGBMAlgorithm:
    ...
    def learning(self, x_training, y_training):
        ...
        self.determination_coefficient_training = lgb.score(self.x_training, self.y_training);
    ...
    def validateAlgorithm(self, forecasters_base, target_base):
        ...
        self.predict_training = lgb.predict(self.x_training);
        ...
        self.average_cross_validation = cross_val_score(lgb, forecasters_base, target_base, cv = kfold).mean() * 100.0;
